...
=======
  return (
    <View className=" bg-black flex h-full w-full items-center justify-center ">
      <Text className="text-white text-center py-6 text-6xl ms:text-3xl mm:text-4xl ml:text-4xl tablet:text-5xl ls:text-6xl ll:text-6xl">
        Who's watching?
      </Text>
      {/* AvatarCard */}
      <View className="flex-row flex-wrap ms:w-52 mm:w-52 ml:w-60">
